 ...
 * @LastEditTime: 2021-10-05 18:59:30
 ...
 * @return {*}
 */
void solution_one_true(MATRIX M) // Not using pointers as parameter for protection
{
...
/**
 * @description: solution one with repeation of K times
 * @param {MATRIX M}
 * @return {*}
 */
